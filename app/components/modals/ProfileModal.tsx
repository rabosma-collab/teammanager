...
export default function ProfileModal({ onClose, onPlayerUpdated, onLogout, welcomeMode = false }: ProfileModalProps) {
          ...
          {onLogout && (
            <div className="pt-4 border-t border-gray-700 mt-2">
              <button
                type="button"
                onClick={onLogout}
                className="w-full px-4 py-2.5 bg-gray-700 hover:bg-red-900/50 text-gray-300 hover:text-red-300 rounded font-medium text-sm transition-colors flex items-center justify-center gap-2"
              >
